...
SpriteDrawingObject::SpriteDrawingObject(TextureAsset* textureAsset, const char* vertexShaderPath, const char* fragmentShaderPath):DrawingObject(textureAsset, 100.0f, vertexShaderPath, fragmentShaderPath) {
