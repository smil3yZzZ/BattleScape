...
ShadowDrawingObject::ShadowDrawingObject(TextureAsset* textureAsset, const char* vertexShaderPath, const char* fragmentShaderPath) :DrawingObject(SPRITE_DRAWING_OBJECT_DIMENSION, textureAsset, CHARACTER_Z_OFFSET, vertexShaderPath, fragmentShaderPath) {
...
void ShadowDrawingObject::updateVerticesAndIndices(float x, float y, int frameState, int direction) {
